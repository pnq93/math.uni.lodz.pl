...
public class TestCase {
  ...
  public void testCase() throws Exception {
    ...
    driver.findElement(By.name("email")).sendKeys("pnq@o2.pl");
    driver.findElement(By.name("repeatEmail")).clear();
    driver.findElement(By.name("repeatEmail")).sendKeys("pnq@o2.pl");
