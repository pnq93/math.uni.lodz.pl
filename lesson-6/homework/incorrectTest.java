...
public class IncorrectTest {
  ...
  public void testIncorrect() throws Exception {
    ...
    driver.findElement(By.name("lastName")).sendKeys("Kowal");
    driver.findElement(By.name("email")).clear();
    driver.findElement(By.name("email")).sendKeys("kowal@o2.pl");
    driver.findElement(By.name("repeatEmail")).clear();
    driver.findElement(By.name("repeatEmail")).sendKeys("kowal@o2.pl");
